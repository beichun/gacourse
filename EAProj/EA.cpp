...
glm::vec3 cameraPos   = glm::vec3(5.0f, 5.0f,  2.0f);
glm::vec3 cameraFront = glm::vec3(-5.0f, -5.0f, -2.0f);
...
int render(ArrayX3dRowMajor& position_history,
    ...
    window = glfwCreateWindow( 1024, 768, "3 * 3 * 50 Cubes", NULL, NULL);
    if( window == NULL ){
